...
const ConversionHistory = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {https://codemoderization123.s3.ap-southeast-2.amazonaws.com/37a3bdca-952a-4f04-ad3e-f2f9dbbf694f-new.json
            try {
                const result = await axios.get(`https://codemoderization123.s3.ap-southeast-2.amazonaws.com/${id}.json`);
